...
class CycleGANTraining(object):
    def __init__(self,
        ...
        self.start_epoch = 0
        self.num_epochs = 100 #200000  # 5000
        ...
        for file in os.listdir(validation_A_dir):
            if file.endswith(".wav"):
                ...
                sf.write(file=os.path.join(output_A_dir, os.path.basename(file)), 
                        data=wav_transformed, samplerate=sampling_rate)
...
if __name__ == '__main__':
    ...
    validation_A_dir_default = './my_data/mandarin/'
    output_A_dir_default = './converted_sound/mandarin/'

    # validation_B_dir_default = './data/gaoxiaosong/'
    # output_B_dir_default = './converted_sound/gaoxiaosong_2/'
    validation_B_dir_default = './my_data/english/'
    output_B_dir_default = './converted_sound/english/'
