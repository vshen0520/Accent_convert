...
- [x] 数据集
  - [ ] VC
  - [x] 中文男性说话人
	(S0913 from [AISHELL-Speech](https://openslr.org/33/) 
	[GaoXiaoSong: a Chinese star](https://en.wikipedia.org/wiki/Gao_Xiaosong))
- [x] 用法
  - [x] 训练
  - [x] Example 
- [ ] Demo
...
To advance the research on non-parallel VC, we propose CycleGAN-VC2, which is an improved version of CycleGAN-VC incorporating three new techniques: 
an improved objective (two-step adversarial losses), 
improved generator (2-1-2D CNN), 
and improved discriminator (Patch GAN).
